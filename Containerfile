...
ARG KERNEL_REF="${KERNEL_REF:-ghcr.io/justinbarno/kernel-bazzite:bazzite-6.17-f43-x86_64}"
ARG NVIDIA_REF="${NVIDIA_REF:-ghcr.io/justinbarno/bazzite-nvidia-drivers:580.126.18-f43-x86_64}"
